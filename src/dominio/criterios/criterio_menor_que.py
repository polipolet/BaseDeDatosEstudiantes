...
class CriterioMenorQue(Criterio):
    """
    ...
    def __init__(self,nombre_clave,valor_a_comparar):
        ...
        raise MetodoNoImplementadoException("CriterioMenorQue::__init__(...) NO SE HA IMPLEMENTADO")
    ...
    # Devuelve True si el valor obtenido es ESTRICTAMENTE MENOR que dicho atributo. Devuelve False en caso contrario.
    #
    ...
    def se_cumple(self,fila):
        from src.dominio.excepcionesDominio import MetodoNoImplementadoException
        raise MetodoNoImplementadoException("CriterioMenorQue::se_cumple(...) NO SE HA IMPLEMENTADO")
    ...
    #
    def __str__(self):
        return f"CriterioMenorQue<{self.nombre_clave},{self.valor_a_comparar},{self.valor_numerico_a_comparar}>"
